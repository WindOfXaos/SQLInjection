...
<body>
    ...
    <div class="row row-cols-1 row-cols-md-4 g-4 justify-content-evenly mt-5">
        ...
        <div class="col m-5" style="max-width: 550px;">
            <div class="card text-center bg-dark text-white">
                <img src="../imgs/2.jpg" class="card-img-top msi" alt="...">
                <div class="card-body">
        ...
        <div class="col m-5" style="max-width: 550px;">
            <div class="card text-center bg-dark text-white">
                <img src="../imgs/3.jpg" class="card-img-top msi" alt="...">
                <div class="card-body">
        ...
        <div class="col m-5" style="max-width: 550px;">
            <div class="card text-center bg-dark text-white">
                <img src="../imgs/4.jpg" class="card-img-top msi" alt="...">
                <div class="card-body">
        ...
        <div class="col m-5" style="max-width: 550px;">
            <div class="card text-center bg-dark text-white">
                <img src="../imgs/5.jpg" class="card-img-top msi" alt="...">
                <div class="card-body">
        ...
        <div class="col m-5" style="max-width: 550px;">
            <div class="card text-center bg-dark text-white">
                <img src="../imgs/6.jpg" class="card-img-top msi" alt="...">
                <div class="card-body">
